...
var u, l;
t: {
  for (var f = ["CLOSURE_FLAGS"], d = t, p = 0; p < f.length; p++)
    if (null == (d = d[f[p]])) {
      l = null;
      break t;
    }
...
const y = t.navigator;
function _(t) {
  return !!u && !!g && g.brands.some(({ brand: e }) => e && -1 != e.indexOf(t));
}
function v(e) {
  var n;
  return (
...
function w() {
  return E()
    ? _("Chromium")
    : ((v("Chrome") || v("CriOS")) && !(!E() && v("Edge"))) || v("Silk");
}
function T(t) {
  return T[" "](t), t;
}
...
var L = "undefined" != typeof Uint8Array,
  R = !b && "function" == typeof btoa;
function F(t) {
  if (!R) {
    var e;
    void 0 === e && (e = 0), x(), (e = A[e]);
...
function O(t) {
  if (!R) return S(t);
  I.test(t) && (t = t.replace(I, P)), (t = atob(t));
  const e = new Uint8Array(t.length);
  for (let n = 0; n < t.length; n++) e[n] = t.charCodeAt(n);
  return e;
}
function C(t) {
  return L && null != t && t instanceof Uint8Array;
}
var U = {};
function N() {
...
function D(t) {
  ...
  var e = t.g;
  return null ==
    (e = null == e || C(e) ? e : "string" == typeof e ? O(e) : null)
    ? e
    : (t.g = e);
}
var B = class {
  ...
  constructor(t, e) {
    if ((V(e), (this.g = t), null != t && 0 === t.length))
      throw Error("ByteString should be constructed with non-empty values");
  }
};
let G, j;
function V(t) {
  if (t !== U) throw Error("illegal external caller");
}
function X(t, e) {
...
function dt(t, e) {
  if (null != t)
    if ("string" == typeof t) t = t ? new B(t, U) : N();
    else if (t.constructor !== B)
      if (C(t)) t = t.length ? new B(new Uint8Array(t), U) : N();
      else {
        if (!e) throw Error();
        t = void 0;
      }
...
function pt(t) {
  return !(!Array.isArray(t) || t.length) && !!(1 & nt(t));
}
const gt = [];
function mt(t) {
  if (2 & t) throw Error();
...
let _t;
function vt(t, e) {
  (e = _t ? e[_t] : void 0) && (t[_t] = K(e));
}
var Et = Object.freeze({});
function wt(t) {
  return (t.Pa = !0), t;
}
var Tt = wt((t) => "number" == typeof t),
  bt = wt((t) => "string" == typeof t),
  At = wt((t) => "boolean" == typeof t),
  kt = "function" == typeof t.BigInt && "bigint" == typeof t.BigInt(0),
  St = wt((t) =>
    kt ? t >= Lt && t <= Ft : "-" === t[0] ? It(t, xt) : It(t, Rt)
  );
const xt = Number.MIN_SAFE_INTEGER.toString(),
  Lt = kt ? BigInt(Number.MIN_SAFE_INTEGER) : void 0,
  Rt = Number.MAX_SAFE_INTEGER.toString(),
  Ft = kt ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
function It(t, e) {
...
function Dt(t) {
  const e = (Pt ||= new DataView(new ArrayBuffer(8)));
  e.setFloat32(0, +t, !0), (Ct = 0), (Ot = e.getUint32(0, !0));
}
function Bt(t, e) {
  const n = 4294967296 * e + (t >>> 0);
  return Number.isSafeInteger(n) ? n : jt(t, e);
}
function Gt(t, e) {
  const n = 2147483648 & e;
  return (
    n && ((e = ~e >>> 0), 0 == (t = (1 + ~t) >>> 0) && (e = (e + 1) >>> 0)),
    "number" == typeof (t = Bt(t, e)) ? (n ? -t : t) : n ? "-" + t : t
  );
}
function jt(t, e) {
...
function Xt(t) {
  if (t.length < 16) Nt(Number(t));
    ...
    (t = BigInt(t)),
      (Ot = Number(t & BigInt(4294967295)) >>> 0),
      (Ct = Number((t >> BigInt(32)) & BigInt(4294967295)));
  else {
    const e = +("-" === t[0]);
    Ct = Ot = 0;
    const n = t.length;
    for (let r = e, i = ((n - e) % 6) + e; i <= n; r = i, i += 6) {
      ...
      (Ct *= 1e6),
        (Ot = 1e6 * Ot + e),
        Ot >= 4294967296 &&
          ((Ct += Math.trunc(Ot / 4294967296)), (Ct >>>= 0), (Ot >>>= 0));
    }
    if (e) {
      const [t, e] = Ht(Ot, Ct);
      (Ot = t), (Ct = e);
...
function Jt(t) {
  return (
    "-" !== t[0] &&
    (t.length < 20 || (20 === t.length && Number(t.substring(0, 6)) < 184467))
  );
}
function Zt(t) {
  return (
    (t = Math.trunc(t)), Number.isSafeInteger(t) || (Nt(t), (t = Gt(Ot, Ct))), t
  );
}
function Qt(t) {
...
function te(t) {
  return null == t
    ...
    ? (St(t)
        ? (t = Number(t))
        : ((t = BigInt.asIntN(64, t)), (t = St(t) ? Number(t) : String(t))),
      t)
    : Yt(t)
    ? "number" == typeof t
      ? Zt(t)
    ...
    if ("number" === e)
      return (t = Math.trunc(t)) >= 0 && Number.isSafeInteger(t)
        ...
        : (function (t) {
            ...
            return Jt((e = String(t))) ? e : (Nt(t), Bt(Ot, Ct));
          })(t);
  }
}
function ne(t) {
...
function se(t, e, n, r) {
  if (null != t && "object" == typeof t && t.X === ht) return t;
  if (!Array.isArray(t))
    return (
      n
        ? 2 & r
          ? (t = e[J])
            ? (e = t)
            : (st((t = new e()).u), (e = e[J] = t))
          : (e = new e())
        : (e = void 0),
      e
    );
  let i = (n = nt(t));
  return 0 === i && (i |= 32 & r), (i |= 2 & r), i !== n && it(t, i), new e(t);
}
function oe(t, e, n) {
  if (e)
    t: {
      if (!Yt((e = t))) throw W("int64");
      switch (typeof e) {
        case "string":
          e = Qt(e);
          break t;
        case "bigint":
          if (((t = e = BigInt.asIntN(64, e)), bt(t))) {
...
function ae(t) {
  var e;
  return (
    void 0 === ue && (ue = "function" == typeof Proxy ? me(Proxy) : null),
    (e = !ue) ||
      (void 0 === le &&
        (le = "function" == typeof WeakMap ? me(WeakMap) : null),
      (e = !le)),
    e
      ? t
      : (e = ce?.get(t))
      ...
      : ((function (t) {
          if (void 0 === fe) {
            const t = new ue([], {});
            fe = 1 === Array.prototype.concat.call([], t).length;
          }
          fe &&
        ...
        (function (t, e) {
          (ce ||= new le()).set(t, e), (he ||= new le()).set(e, t);
        })(t, (e = new ue(t, { set: (t, e, n) => (H(), (t[e] = n), !0) }))),
        e)
  );
}
let ce, he, ue, le, fe, de, pe, ge;
function me(t) {
  try {
...
function ye(t, e, n) {
  return (t = _e(t, e[0], e[1], n ? 1 : 2)), e !== pe && n && tt(t, 16384), t;
}
function _e(t, e, n, r) {
  if (((r = r ?? 0), null == t && (t = de), (de = void 0), null == t)) {
    ...
    if (2048 & (i = nt(t))) throw Error("farr");
    if (64 & i) return t;
...
const Te = Ee
  ? (Object.setPrototypeOf(we.prototype, Map.prototype),
...
var ke = class extends Te {
  ...
  values() {
    var t = this.na();
    return new yt(t, ke.prototype.get, this);
  }
  forEach(t, e) {
    super.forEach((n, r) => {
  ...
  get(t) {
    ...
    if (void 0 !== e) {
      var n = this.T;
      return n
        ? ((n = this.Z(e, !1, !0, n, this.sa, this.M)) !== e && super.set(t, n),
          n)
        : e;
    }
  }
...
function Se(t, e, n, r, i, s) {
  return (t = se(t, r, n, s)), i && (t = De(t)), t;
}
function xe(t) {
  return t;
}
...
function Ie(t, e, n, r, i) {
  if (null != t) {
    if (Array.isArray(t))
      t = pt(t) ? void 0 : i && 2 & nt(t) ? t : Me(t, e, n, void 0 !== r, i);
    else if (ft(t)) {
      const s = {};
      for (let o in t) s[o] = Ie(t[o], e, n, r, i);
      t = s;
    } else t = e(t, r);
    return t;
  }
...
function Me(t, e, n, r, i) {
  ...
  r = r ? !!(32 & s) : void 0;
  const o = K(t);
  for (let t = 0; t < o.length; t++) o[t] = Ie(o[t], e, n, r, i);
  return n && (vt(o, t), n(s, o)), o;
}
function Pe(t) {
  return Ie(t, Oe, void 0, void 0, !1);
}
function Oe(t) {
  return t.X === ht
    ? t.toJSON()
...
function Ce(t, e, n = at) {
  if (null != t) {
    if (L && t instanceof Uint8Array) return e ? t : new Uint8Array(t);
    if (Array.isArray(t)) {
      var r = nt(t);
      return 2 & r
        ? t
        : ((e &&= 0 === r || (!!(32 & r) && !(64 & r || !(16 & r)))),
          e
            ? (it(t, -12293 & (34 | r)), t)
            : Me(t, Ce, 4 & r ? at : n, !0, !0));
    }
    return (
      t.X === ht
        ? ((n = t.u), (t = 2 & (r = rt(n)) ? t : Ue(t, n, r, !0)))
        : t instanceof ke &&
          !(2 & t.M) &&
          ((n = st(t.Y(Ce))), (t = new ke(n, t.T, t.S, t.Z))),
      t
    );
  }
}
...
function De(t) {
  const e = t.u,
    n = rt(e);
  return 2 & n ? Ue(t, e, n, !1) : t;
}
function Be(t, e) {
  return je((t = t.u), rt(t), e);
}
function Ge(t, e, n, r) {
...
function He(t, e) {
  ...
  const r = je(t, n, e),
    i = Wt(r);
  return null != i && i !== r && Xe(t, n, e, i), i;
}
function We(t) {
  t = t.u;
  let e = rt(t);
  const n = je(t, e, 1),
    r = dt(n, !0);
  return null != r && r !== n && Xe(t, e, 1, r), r;
}
function ze() {
...
function Ke(t, e, n, r, i) {
  ...
  var a = nt(r);
  if (!(4 & a)) {
    4 & a && ((r = K(r)), (a = fn(a, t)), (t = Xe(s, t, e, r)));
    let i = 0,
      o = 0;
    for (; i < r.length; i++) {
      const t = n(r[i]);
  ...
  return (
    1 === o || (4 === o && 32 & a)
      ? qe(a) || ((i = a), (a |= 2) !== i && it(r, a), Object.freeze(r))
      : ((n = 5 === o && (!!(32 & a) || qe(a) || !!ce?.get(r))),
        (2 === o || n) &&
          qe(a) &&
          ((r = K(r)),
          (a = dn((a = fn(a, t)), t, i)),
          it(r, a),
          (t = Xe(s, t, e, r))),
        qe(a) || ((e = a), (a = dn(a, t, i)) !== e && it(r, a)),
        n ? (c = ae(r)) : 2 !== o || i || ce?.delete(r)),
    c || r
  );
}
function Ye(t, e, n, r) {
  return (t = je(t, e, n, r)), Array.isArray(t) ? t : ct;
}
function $e(t, e) {
  return 0 === t && (t = fn(t, e)), 1 | t;
}
function qe(t) {
...
function Ze(t, e, n, r) {
  t = t.u;
  let i = rt(t);
  mt(i), Xe(t, i, e, ("0" === r ? 0 === Number(n) : n === r) ? void 0 : n);
}
function Qe(t, e, n, r, i) {
  mt(e);
  var s = !(!(64 & e) && 16384 & e);
  const o = (i = Ye(t, e, n, i)) !== ct;
  if (s || !o) {
    let a = (s = o ? nt(i) : 0);
    (!o || 2 & a || qe(a) || (4 & a && !(32 & a))) &&
      ((i = K(i)), (a = fn(a, e)), (e = Xe(t, e, n, i))),
      (a = -13 & $e(a, e)),
      (a = dn(r ? -17 & a : 16 | a, e, !0)),
      a !== s && it(i, a);
  }
  return i;
}
function tn(t, e) {
  var n = As;
  return rn(en((t = t.u)), t, rt(t), n) === e ? e : -1;
}
function en(t) {
  if (Y) return t[Q] ?? (t[Q] = new Map());
...
function nn(t, e, n, r) {
  const i = en(t),
    s = rn(i, t, e, n);
  return s !== r && (s && (e = Xe(t, e, s)), i.set(n, r)), e;
}
function rn(t, e, n, r) {
  let i = t.get(r);
  if (null != i) return i;
  ...
  for (let t = 0; t < r.length; t++) {
    const s = r[t];
    null != je(e, n, s) && (0 !== i && (n = Xe(e, n, i)), (i = s));
  }
  return t.set(r, i), i;
}
function sn(t, e, n, r) {
  let i,
    s = rt(t);
  if (null != (r = je(t, s, n, r)) && r.X === ht)
    return (e = De(r)) !== r && Xe(t, s, n, e), e.u;
  if (Array.isArray(r)) {
    const t = nt(r);
    i = 2 & t ? ye(Ne(r, t, !1), e, !0) : 64 & t ? r : ye(i, e, !0);
  } else i = ye(void 0, e, !0);
  return i !== r && Xe(t, s, n, i), i;
}
function on(t, e, n, r) {
  t = t.u;
  let i = rt(t);
  return (
    (e = se((r = je(t, i, n, r)), e, !1, i)) !== r &&
      null != e &&
      Xe(t, i, n, e),
    e
  );
...
function cn(t, e, n, r, i, s, o) {
  t = t.u;
  var a = !!(2 & e);
  (i = a ? 1 : i), (s = !!s), (o &&= !a), (a = Ye(t, e, r));
  var c = nt(a),
    h = !!(4 & c);
  if (!h) {
    var u = a,
  ...
  if (o && !(8 & c || (!a.length && (1 === i || (4 === i && 32 & c))))) {
    for (
      qe(c) && ((a = K(a)), (c = fn(c, e)), (e = Xe(t, e, r, a))),
        n = a,
        o = c,
        u = 0;
      u < n.length;
      ...
      (c = n[u]) !== (l = De(c)) && (n[u] = l);
    (o |= 8), (o = n.length ? -17 & o : 16 | o), it(n, o), (c = o);
  }
  let f;
  return (
    1 === i || (4 === i && 32 & c)
      ? qe(c) ||
        ((e = c),
        (c |= !a.length || (16 & c && (!h || 32 & c)) ? 2 : 2048) !== e &&
          it(a, c),
        Object.freeze(a))
      : ((h = 5 === i && (!!(32 & c) || qe(c) || !!ce?.get(a))),
        (2 === i || h) &&
          qe(c) &&
          ((a = K(a)),
          (c = dn((c = fn(c, e)), e, s)),
          it(a, c),
          (e = Xe(t, e, r, a))),
        qe(c) || ((r = c), (c = dn(c, e, s)) !== r && it(a, c)),
        h ? (f = ae(a)) : 2 !== i || s || ce?.delete(a)),
    f || a
  );
}
function hn(t, e, n) {
  const r = rt(t.u);
  return cn(t, r, e, n, ze(), !1, !(2 & r));
}
function un(t, e, n, r) {
  return null == r && (r = void 0), Ve(t, n, r);
}
function ln(t, e, n, r) {
  null == r && (r = void 0);
  t: {
...
function En(t, e, n) {
  if (null != n) {
    if ("number" != typeof n) throw W("int32");
    if (!Number.isFinite(n)) throw W("int32");
    n |= 0;
  }
  Ve(t, e, n);
}
...
function Tn(t, e, n) {
  {
    ...
    if ((mt(a), null == n)) Xe(o, a, e);
      ...
      for (
        i || (t = 0),
          s || ((n = K(n)), (r = 0), (t = dn((t = fn(t, a)), a, !0)), (s = !1)),
          t |= 21,
          i = 0;
        i < n.length;
        i++
        ...
        Object.is(e, o) ||
          (s &&
            ((n = K(n)), (r = 0), (t = dn((t = fn(t, a)), a, !0)), (s = !1)),
          (n[i] = o));
      }
      t !== r && (s && ((n = K(n)), (t = dn((t = fn(t, a)), a, !0))), it(n, t)),
        Xe(o, a, e, n);
    }
  }
}
function bn(t, e, n) {
  mt(rt(t.u)), Ke(t, e, ie, 2, !0).push(ne(n));
}
function An(t, e) {
...
function xn(t) {
  if ("string" == typeof t) return { buffer: O(t), O: !1 };
  ...
  if (t.constructor === B) return { buffer: D(t) || new Uint8Array(0), O: !0 };
...
function Ln(t, e) {
  ...
  for (s > 32 && (i |= (127 & n) >> 4), s = 3; s < 32 && 128 & n; s += 7)
    (n = o[a++]), (i |= (127 & n) << s);
  if ((Un(t, a), n < 128)) return e(r >>> 0, i >>> 0);
  throw kn();
}
function Rn(t) {
  let e = 0,
  ...
  for (; n < r; ) {
    const r = i[n++];
    if (((e |= r), 0 == (128 & r))) return Un(t, n), !!(127 & e);
  }
  throw kn();
}
function Fn(t) {
...
function Gn(t) {
  ...
  t.l = t.g.g;
  var n = In(t.g);
  if (((e = n >>> 3), !((n &= 7) >= 0 && n <= 5))) throw An(n, t.l);
...
function jn(t) {
  switch (t.h) {
    ...
    case 3:
      for (e = t.m; ; ) {
        if (!Gn(t)) throw Error("Unmatched start-group tag: stream EOF");
        if (4 == t.h) {
...
function Vn(t, e, n) {
  ...
  let o = s - r;
  if (
    (o <= 0 && ((t.g.l = s), n(e, t, void 0, void 0, void 0), (o = s - t.g.g)),
    o)
  )
    throw Error(
...
function qn(t) {
  (t = t.u), (t = Kn ? t : Me(t, Oe, void 0, void 0, !1));
  {
    var e = !Kn;
    let h = t.length;
    if (h) {
      ...
      for (
        ;
        h > 0 && (null == (s = i[h - 1]) || pt(s) || (lt(s) && 0 === s.size));
        h--
      )
        var c = !0;
      (i !== t || o || c) &&
...
function hr(t, e) {
  return cr(t, e, 2), (e = t.g.end()), ar(t, e), e.push(t.h), e;
}
function ur(t, e) {
  var n = e.pop();
...
function lr(t, e, n) {
  cr(t, e, 2), ir(t.g, n.length), ar(t, t.g.end()), ar(t, n);
}
function fr(t, e, n, r) {
  null != n && ((e = hr(t, e)), r(n, t), ur(t, e));
}
function dr() {
  const t = class {
    constructor() {
...
function Ar(t, e) {
  return new br(t, e, pr);
}
function kr(t, e, n, r, i) {
  fr(t, n, Ur(e, r), i);
}
const Sr = Ar(function (t, e, n, r, i) {
    return 2 === t.h && (Vn(t, sn(e, r, n), i), !0);
  }, kr),
  xr = Ar(function (t, e, n, r, i) {
    return 2 === t.h && (Vn(t, sn(e, r, n, !0), i), !0);
  }, kr);
var Lr = Symbol(),
  Rr = Symbol(),
  Fr = Symbol(),
...
function Or(t, e, n, r) {
  ...
  for (c = 1; void 0 !== s; ) {
    ...
    var h = void 0;
    if ((s instanceof br ? (t = s) : ((t = Sr), o--), t?.l)) {
      (s = r[++o]), (h = r);
      var u = o;
...
function Cr(t) {
  return Array.isArray(t) ? (t[0] instanceof br ? t : [xr, t]) : [t, void 0];
}
function Ur(t, e) {
  return t instanceof $n ? t.u : Array.isArray(t) ? ye(t, e, !1) : void 0;
}
function Nr(t, e, n, r) {
  const i = n.g;
...
function Dr(t, e, n, r, i) {
  const s = n.g;
  let o, a;
  t[e] = (t, e, n) => s(t, e, n, (a ||= Or(Rr, Nr, Dr, r).W), (o ||= Br(r)), i);
}
function Br(t) {
  let e = t[Fr];
  if (null != e) return e;
  const n = Or(Rr, Nr, Dr, t);
  return (
    (e = n.ma
      ? (t, e) => Mr(t, e, n)
      : (t, e) => {
          ...
          for (; Gn(e) && 4 != e.h; ) {
            ...
            (null != s && s(e, t, i)) ||
              ...
              s.ga
                ? (s = void 0)
                : ((o = s.g.g - i), (s.g.g = i), (s = Dn(s.g, o))),
              (i = t),
              s &&
                ((_t ||= Symbol()), (o = i[_t]) ? o.push(s) : (i[_t] = [s])));
          }
          return 16384 & r && st(t), !0;
        }),
    (t[Fr] = e)
  );
}
...
function Vr(t, e, n, r) {
  let i, s;
  const o = n.h;
  t[e] = (t, e, n) => o(t, e, n, (s ||= Or(Lr, jr, Vr, r).W), (i ||= Xr(r)));
}
function Xr(t) {
  let e = t[Ir];
  if (!e) {
    const n = Or(Lr, jr, Vr, t);
    (e = (t, e) => Hr(t, e, n)), (t[Ir] = e);
  }
  return e;
}
function Hr(t, e, n) {
  ...
  if (256 & r) {
    ...
    for (const t in r)
      (i = +t),
        Number.isNaN(i) || (null != (s = r[i]) && (a = Wr(n, i)) && a(e, s, i));
  }
  if ((t = _t ? t[_t] : void 0))
    for (ar(e, e.g.end()), n = 0; n < t.length; n++)
      ar(e, D(t[n]) || new Uint8Array(0));
}
function Wr(t, e) {
  var n = t[e];
  if (n) return n;
  if ((n = t.ha) && (n = n[e])) {
    ...
    if ((n = n[1])) {
      const e = Xr(n),
        i = Or(Lr, jr, Vr, n).W;
      n = t.ma ? Pr(i, e) : (t, n, s) => r(t, n, s, i, e);
    } else n = r;
    return (t[e] = n);
  }
}
...
var qr = Ar(
  function (t, e, n, r, i) {
    return (
      2 === t.h &&
      ((t = Vn(t, ye([void 0, void 0], r, !0), i)),
      mt((r = rt(e))),
      (i = je(e, r, n)) instanceof ke
        ? 0 != (2 & i.M)
          ? ((i = i.Y()).push(t), Xe(e, r, n, i))
          : i.Na(t)
        : Array.isArray(i)
        ? (2 & nt(i) && Xe(e, r, n, (i = Je(i))), i.push(t))
        : Xe(e, r, n, [t]),
      !0)
    );
  },
  function (t, e, n, r, i) {
    if (e instanceof ke)
      ...
      for (let s = 0; s < e.length; s++) {
        const o = e[s];
        Array.isArray(o) && fr(t, n, ye(o, r, !1), i);
      }
  }
);
function Jr(t, e, n) {
  if (
    ((e = (function (t) {
      ...
      if (Yt(t)) {
        if ("string" === e) return Qt(t);
        if ("number" === e) return Zt(t);
      }
    })(e)),
    null != e)
  ) {
    ...
    if (null != e)
      switch ((cr(t, n, 0), typeof e)) {
        case "number":
          (t = t.g), Nt(e), rr(t, Ot, Ct);
          break;
        case "bigint":
          ...
          break;
        default:
          (n = tr(e)), rr(t.g, n.h, n.g);
      }
  }
}
function Zr(t, e, n) {
  null != (e = $t(e)) && null != e && (cr(t, n, 0), sr(t.g, e));
}
function Qr(t, e, n) {
  null != (e = zt(e)) && (cr(t, n, 0), t.g.g.push(e ? 1 : 0));
}
function ti(t, e, n) {
  null != (e = ie(e)) && lr(t, n, h(e));
}
...
function ni(t, e, n) {
  null !=
    (e =
      null == e || "string" == typeof e || C(e) || e instanceof B
        ? e
        : void 0) && lr(t, n, xn(e).buffer);
}
function ri(t, e, n) {
  return (
    (5 === t.h || 2 === t.h) &&
    ((e = Qe(e, rt(e), n, !1, !1)),
    2 == t.h ? Wn(t, Pn, e) : e.push(Pn(t.g)),
    !0)
  );
}
var ii = Kr(
    ...
    function (t, e, n) {
      null != (e = Wt(e)) &&
        (cr(t, n, 1),
        (t = t.g),
        (n = Pt ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e, !0),
        (Ot = n.getUint32(0, !0)),
        (Ct = n.getUint32(4, !0)),
        or(t, Ot),
        or(t, Ct));
  ...
  si = Kr(
    function (t, e, n) {
      return 5 === t.h && ($r(e, n, Pn(t.g)), !0);
    },
    function (t, e, n) {
      null != (e = Wt(e)) && (cr(t, n, 5), (t = t.g), Dt(e), or(t, Ot));
    },
    Er
  ),
  oi = Yr(
      ...
      if (null != (e = zr(Wt, e)))
        for (let o = 0; o < e.length; o++) {
          var r = t,
            i = n,
            s = e[o];
          null != s && (cr(r, i, 5), (r = r.g), Dt(s), or(r, Ot));
        }
    },
    Er
  ),
  ai = Yr(
    ri,
    function (t, e, n) {
      if (null != (e = zr(Wt, e)) && e.length) {
        cr(t, n, 2), ir(t.g, 4 * e.length);
        for (let r = 0; r < e.length; r++) (n = t.g), Dt(e[r]), or(n, Ot);
      }
    },
    Er
  ),
  ci = Kr(
    function (t, e, n) {
      return 0 === t.h && ($r(e, n, Ln(t.g, Gt)), !0);
    },
    Jr,
    vr
  ),
  hi = Kr(
    function (t, e, n) {
      return 0 === t.h && ($r(e, n, 0 === (t = Ln(t.g, Gt)) ? void 0 : t), !0);
    },
    Jr,
    vr
  ),
  ui = Kr(
    function (t, e, n) {
      return 0 === t.h && ($r(e, n, Ln(t.g, Bt)), !0);
    },
    function (t, e, n) {
      if (null != (e = ee(e))) {
        if ("string" == typeof e) Jn(e);
        if (null != e)
          switch ((cr(t, n, 0), typeof e)) {
            case "number":
              (t = t.g), Nt(e), rr(t, Ot, Ct);
  ...
  li = Kr(
    ...
    function (t, e, n) {
      return (
        (0 === t.h || 2 === t.h) &&
        ((e = Qe(e, rt(e), n, !1, !1)),
        2 == t.h ? Wn(t, Fn, e) : e.push(Fn(t.g)),
        !0)
      );
    },
    function (t, e, n) {
      if (null != (e = zr($t, e)) && e.length) {
        n = hr(t, n);
        for (let n = 0; n < e.length; n++) sr(t.g, e[n]);
        ur(t, n);
      }
    },
    yr
  ...
  di = Kr(
    function (t, e, n) {
      return 0 === t.h && ($r(e, n, 0 === (t = Fn(t.g)) ? void 0 : t), !0);
    },
    Zr,
    yr
  ),
  ...
  gi = Kr(
    function (t, e, n) {
      return 0 === t.h && ($r(e, n, !1 === (t = Rn(t.g)) ? void 0 : t), !0);
    },
    Qr,
    gr
  ),
  mi = Yr(
    function (t, e, n) {
      return 2 === t.h && ((t = Xn(t)), Qe(e, rt(e), n, !1).push(t), !0);
    },
    function (t, e, n) {
      if (null != (e = zr(ie, e)))
        for (let o = 0; o < e.length; o++) {
  ...
  yi = Kr(
    function (t, e, n) {
      return 2 === t.h && ($r(e, n, "" === (t = Xn(t)) ? void 0 : t), !0);
    },
    ti,
    mr
  ),
  _i = Kr(
    function (t, e, n) {
      return 2 === t.h && ($r(e, n, Xn(t)), !0);
    },
    ti,
    mr
  ),
  vi = (function (t, e, n = pr) {
    return new br(t, e, n);
  })(
    function (t, e, n, r, i) {
      return (
        2 === t.h &&
        ((r = ye(void 0, r, !0)), Qe(e, rt(e), n, !0).push(r), Vn(t, r, i), !0)
      );
    },
    function (t, e, n, r, i) {
      if (Array.isArray(e))
        for (let s = 0; s < e.length; s++) ei(t, e[s], n, r, i);
    }
  ),
  Ei = Ar(function (t, e, n, r, i, s) {
    return 2 === t.h && (nn(e, nt(e), s, n), Vn(t, (e = sn(e, r, n)), i), !0);
  }, ei),
  wi = Kr(
    function (t, e, n) {
      return 2 === t.h && ($r(e, n, Hn(t)), !0);
    },
    ni,
    wr
  ),
  ...
  bi = Kr(
    function (t, e, n) {
      return 0 === t.h && ($r(e, n, 0 === (t = In(t.g)) ? void 0 : t), !0);
    },
    function (t, e, n) {
      null != (e = qt(e)) && null != e && (cr(t, n, 0), ir(t.g, e));
    },
    _r
  ),
  Ai = Kr(
    ...
    function (t, e, n) {
      null != (e = $t(e)) && ((e = parseInt(e, 10)), cr(t, n, 0), sr(t.g, e));
    },
    Tr
  );
class ki {
...
function xi(t, e) {
  return (n, r) => {
    ...
    try {
      ...
      n.g.clear(), (n.m = -1), (n.h = -1), zn.length < 100 && zn.push(n);
    }
    return i;
  };
}
function Li(t) {
  return function () {
    ...
    Hr(this.u, e, Or(Lr, jr, Vr, t)), ar(e, e.g.end());
...
var Ri = class extends $n {
  ...
  Fi = [
    ...
    Kr(
      function (t, e, n) {
        return 2 === t.h && ($r(e, n, (t = Hn(t)) === N() ? void 0 : t), !0);
      },
      function (t, e, n) {
        if (null != e) {
          if (e instanceof $n) {
            const r = e.Qa;
            return void (
              r && ((e = r(e)), null != e && lr(t, n, xn(e).buffer))
            );
          }
...
Xi[336783863] = [
  ...
  [0, _i],
  pi,
  [0, [1, 3], [2, 4], Ei, [0, fi], -1, Ei, [0, mi], -1, vi, [0, _i, -1]],
  _i,
];
...
var vs = class extends $n {
  ...
  Ps = class extends $n {
    ...
    g() {
      return zt(Be(this, 2)) ?? !1;
    }
  },
  Os = [0, wi, _i, [0, li, ci, -1], [0, ui, ci]],
  Cs = [0, Os, pi, [0, Is, Ei, ji, Ei, Ni, Ei, Ci, Ei, Gi, Ei, Di], Ai],
  Us = class extends $n {
    constructor(t) {
      super(t);
    }
        ...
        return (
          (t = (function (t, e, n) {
            ...
            if (null == n) {
              ...
              n = n.Y();
            } else Array.isArray(n) ? (s = !!(2 & nt(n))) : (n = []);
            if (i) {
              if (!n.length) return Fe();
              s || ((s = !0), st(n));
            } else s && ((s = !1), (n = Je(n)));
            return (
              s || (64 & nt(n) ? et(n, 32) : 32 & e && tt(n, 32)),
              Xe(t, e, 2, (r = new ke(n, r, oe, void 0))),
              r
            );
          })(t, e, je(t, e, 2))),
          !n && _o && (t.sa = !0),
...
Xi[458105876] = [0, vo, qr, [!0, ci, [0, _i, -1, mi]]];
...
function xo(t, e) {
  return (
    ...
    void 0 !== t.displayNamesLocale
      ? Ve(e, 1, re(t.displayNamesLocale))
      : void 0 === t.displayNamesLocale && Ve(e, 1),
    void 0 !== t.maxResults
      ? En(e, 2, t.maxResults)
      : "maxResults" in t && Ve(e, 2),
    void 0 !== t.scoreThreshold
      ? wn(e, 3, t.scoreThreshold)
      : "scoreThreshold" in t && Ve(e, 3),
    void 0 !== t.categoryAllowlist
      ? Tn(e, 4, t.categoryAllowlist)
      : "categoryAllowlist" in t && Ve(e, 4),
    void 0 !== t.categoryDenylist
      ? Tn(e, 5, t.categoryDenylist)
      : "categoryDenylist" in t && Ve(e, 5),
    e
  );
}
function Lo(t, e = -1, n = "") {
...
async function Uo() {
  if (void 0 === Oo)
    try {
      await WebAssembly.instantiate(Co), (Oo = !0);
    } catch {
      Oo = !1;
    }
  return Oo;
}
async function No(t, e = Oi``) {
  const n = (await Uo()) ? "wasm_internal" : "wasm_nosimd_internal";
  return {
...
(Do.forVisionTasks = function (t) {
  return No("vision", t);
}),
  (Do.forTextTasks = function (t) {
    return No("text", t);
  }),
  (Do.forGenAiExperimentalTasks = function (t) {
    return No("genai_experimental", t);
  }),
  (Do.forGenAiTasks = function (t) {
    return No("genai", t);
  }),
  (Do.forAudioTasks = function (t) {
    return No("audio", t);
  }),
...
async function Ko(t, e, n, r) {
  return (
    (t = await (async (t, e, n, r, i) => {
      if ((e && (await Go(e)), !self.ModuleFactory))
        throw Error("ModuleFactory not set.");
      if (n && (await Go(n), !self.ModuleFactory))
        throw Error("ModuleFactory not set.");
      return (
        self.Module &&
          i &&
...
function Yo(t, e) {
  const n = an(t.baseOptions, Ms, 1) || new Ms();
  "string" == typeof e
    ? (Ve(n, 2, re(e)), Ve(n, 1))
    : e instanceof Uint8Array && (Ve(n, 1, dt(e, !1)), Ve(n, 2)),
    un(t.baseOptions, 0, 1, n);
}
function $o(t) {
  try {
    const e = t.H.length;
...
function Jo(t, e) {
  (t.A = new Yi()),
    Wi(t.A, "PassThroughCalculator"),
    zi(t.A, "free_memory"),
    Ki(t.A, "free_memory_unused_out"),
    Qi(e, "free_memory"),
    Zi(e, t.A);
}
function Zo(t, e) {
  zi(t.A, e), Ki(t.A, e + "_unused_out");
}
function Qo(t) {
...
var ta = class {
  ...
  l(t, e = !0) {
    if (e) {
      ...
      if (
        !(
          an(this.baseOptions, Ms, 1)?.g() ||
          an(this.baseOptions, Ms, 1)?.h() ||
      ...
      if (
        ((function (t, e) {
          ...
          "delegate" in e &&
            ("GPU" === e.delegate
              ? ((e = n), (r = new Ui()), ln(e, 2, Is, r))
              : ((e = n), (r = new Bi()), ln(e, 4, Is, r))),
            un(t.baseOptions, 0, 3, n);
        })(this, e),
        e.modelAssetPath)
      )
...
function ra(t, e, n) {
  const r = t.g;
  if (
    ((n = ea(r.createShader(n), "Failed to create WebGL shader")),
    r.shaderSource(n, e),
    r.compileShader(n),
...
function ia(t, e) {
  const n = t.g,
    r = ea(n.createVertexArray(), "Failed to create vertex array");
  n.bindVertexArray(r);
  const i = ea(n.createBuffer(), "Failed to create buffer");
  ...
  const s = ea(n.createBuffer(), "Failed to create buffer");
  return (
...
function oa(t, e, n, r) {
  return (
    ...
    t.h || (t.m(), t.C()),
    n
      ? (t.s || (t.s = ia(t, !0)), (n = t.s))
      : (t.v || (t.v = ia(t, !1)), (n = t.v)),
    e.useProgram(t.h),
    n.bind(),
    t.l(),
    (t = r()),
...
function aa(t, e, n) {
  return (
    sa(t, e),
    (t = ea(e.createTexture(), "Failed to create texture")),
...
function ca(t, e, n) {
  sa(t, e),
    t.A || (t.A = ea(e.createFramebuffer(), "Failed to create framebuffe.")),
...
var ua = class {
  ...
  m() {
    const t = this.g;
    if (
      ((this.h = ea(t.createProgram(), "Failed to create WebGL program")),
      (this.ba = ra(
        this,
        "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }",
        t.VERTEX_SHADER
      )),
      (this.aa = ra(this, this.H(), t.FRAGMENT_SHADER)),
...
var la = class extends ua {
    ...
    C() {
      ...
      t.activeTexture(t.TEXTURE1),
        (this.B = aa(this, t, t.LINEAR)),
        t.activeTexture(t.TEXTURE2),
        (this.j = aa(this, t, t.NEAREST));
    }
    m() {
      super.m();
      const t = this.g;
...
function pa(t) {
  var e = da(t, 1);
  if (!e) {
    if ((e = da(t, 0))) e = new Float32Array(e).map((t) => t / 255);
    else {
...
function va(t) {
  ...
  return (
    n ||
      ((n = aa(_a(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
        ...
        if (e instanceof Uint8Array) n = new Uint8Array(e);
            ...
            throw Error(`Type is not supported: ${e}`);
          {
            const t = ma(this),
              e = _a(this);
            t.activeTexture(t.TEXTURE1),
              (n = aa(e, t, this.m ? t.LINEAR : t.NEAREST)),
...
(Ta.prototype.close = Ta.prototype.close),
  ...
  (Ta.prototype.getAsWebGLTexture = Ta.prototype.N),
  (Ta.prototype.getAsFloat32Array = Ta.prototype.ia),
  (Ta.prototype.getAsUint8Array = Ta.prototype.ja),
  (Ta.prototype.hasWebGLTexture = Ta.prototype.R),
  (Ta.prototype.hasFloat32Array = Ta.prototype.ka),
  (Ta.prototype.hasUint8Array = Ta.prototype.Ga);
var ba = 250;
const Aa = { color: "white", lineWidth: 4, radius: 6 };
function ka(t) {
  return { ...Aa, fillColor: (t = t || {}).color, ...t };
}
function Sa(t, e) {
...
function Fa(t, e, n) {
  if (e.R()) n(e.N());
    ...
    t.m = t.m ?? new ua();
    const i = Ra(t);
    n((t = new Ta([r], e.m, !1, i.canvas, t.m, e.width, e.height)).N()),
      t.close();
  }
}
function Ia(t, e, n, r) {
  const i = (function (t) {
      return t.g || (t.g = new la()), t.g;
    })(t),
    s = Ra(t),
...
var Pa = class {
  ...
  za(t, e) {
    if (t) {
      ...
      var r = n.canvas,
        i = 0;
      for (const s of t)
        (n.fillStyle = Sa(e.fillColor, { index: i, from: s })),
          (n.strokeStyle = Sa(e.color, { index: i, from: s })),
          (n.lineWidth = Sa(e.lineWidth, { index: i, from: s })),
          (t = new Path2D()).arc(
            s.x * r.width,
            s.y * r.height,
            Sa(e.radius, { index: i, from: s }),
            0,
            2 * Math.PI
          ),
          n.fill(t),
  ...
  ya(t, e, n) {
    if (t && e) {
      ...
      for (const o of e) {
        ...
        e &&
          a &&
          ((r.strokeStyle = Sa(n.color, { index: s, from: e, to: a })),
          (r.lineWidth = Sa(n.lineWidth, { index: s, from: e, to: a })),
  ...
  va(t, e) {
    ...
    (e = ka(e)),
      n.save(),
      n.beginPath(),
      (n.lineWidth = Sa(e.lineWidth, {})),
      (n.strokeStyle = Sa(e.color, {})),
      (n.fillStyle = Sa(e.fillColor, {})),
...
function Ua(t) {
  ...
  if (!e) {
    ...
    e = Ba(t);
    const r = Oa(t, 1) || Ca(t);
    n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, n.RGBA, n.UNSIGNED_BYTE, r), Ga(t);
  }
  return e;
}
function Na(t) {
...
function Ba(t) {
  ...
  let n = Oa(t, 2);
  return (
    n || ((n = aa(Da(t), e)), t.g.push(n), (t.m = !0)),
    e.bindTexture(e.TEXTURE_2D, n),
    n
  );
}
...
(Pa.prototype.close = Pa.prototype.close),
  (Pa.prototype.drawConfidenceMask = Pa.prototype.xa),
  (Pa.prototype.drawCategoryMask = Pa.prototype.wa),
  (Pa.prototype.drawBoundingBox = Pa.prototype.va),
  (Pa.prototype.drawConnectors = Pa.prototype.ya),
  (Pa.prototype.drawLandmarks = Pa.prototype.za),
  (Pa.lerp = function (t, e, n, r, i) {
    return xa(r * (1 - (t - e) / (n - e)) + i * (1 - (n - t) / (n - e)), r, i);
  }),
  (Pa.clamp = xa),
  e("DrawingUtils", Pa);
var Va = class {
    ...
    for (const e of this.g) {
      ...
      if (e instanceof ImageData)
        ...
        if (!(e instanceof ImageBitmap))
          throw Error(`Type is not supported: ${e}`);
        Ua(this), Ba(this), (n = ja(this)), Ga(this);
      }
      t.push(n);
    }
    return new Va(
  ...
  close() {
    this.j && Oa(this, 1).close(),
      this.m && Na(this).deleteTexture(Oa(this, 2)),
      (Xa = -1);
  }
};
(Va.prototype.close = Va.prototype.close),
  (Va.prototype.clone = Va.prototype.clone),
  (Va.prototype.getAsWebGLTexture = Va.prototype.N),
  (Va.prototype.getAsImageBitmap = Va.prototype.Ca),
  (Va.prototype.getAsImageData = Va.prototype.Da),
  (Va.prototype.hasWebGLTexture = Va.prototype.R),
  (Va.prototype.hasImageBitmap = Va.prototype.la),
  (Va.prototype.hasImageData = Va.prototype.Fa);
var Xa = 250;
function Ha(...t) {
  ...
  ((za = class {
    ...
    configureAudio(t, e, n, r, i) {
      this.i._configureAudio ||
        ...
        Vo(this, r || "input_audio", (r) => {
          Vo(this, (i = i || "audio_header"), (i) => {
    ...
    ea(t) {
      Wo(this, "__graph_config__", (e) => {
        t(e);
      }),
        Vo(this, "__graph_config__", (t) => {
    ...
    addStringRecordToStream(t, e, n) {
      Vo(this, e, (e) => {
        Ho(this, Object.keys(t), (r) => {
          Ho(this, Object.values(t), (i) => {
...
async function Ya(t, e, n) {
  return (async function (t, e, n, r) {
    return Ko(t, e, n, r);
  })(t, n.canvas ?? (Bo() ? void 0 : document.createElement("canvas")), e, n);
}
function $a(t, e, n, r) {
  if (t.U) {
    const s = new _s();
    if (n?.regionOfInterest) {
      if (!t.qa) throw Error("This task doesn't support region-of-interest.");
      ...
      wn(s, 1, (i.left + i.right) / 2),
        wn(s, 2, (i.top + i.bottom) / 2),
        wn(s, 4, i.right - i.left),
        wn(s, 3, i.bottom - i.top);
    } else wn(s, 1, 0.5), wn(s, 2, 0.5), wn(s, 4, 1), wn(s, 3, 1);
    if (n?.rotationDegrees) {
      if (n?.rotationDegrees % 90 != 0)
        throw Error("Expected rotation to be a multiple of 90°.");
      if (
        (wn(s, 5, (-Math.PI * n.rotationDegrees) / 180),
  ...
  t.g.ra(e, t.ba, r ?? performance.now()), t.finishProcessing();
}
function qa(t, e, n) {
  if (t.baseOptions?.g())
    throw Error(
...
function Za(t, e, n, r) {
  ...
  return (t = new Ta([i], n, !1, t.g.i.canvas, t.P, s, e)), r ? t.clone() : t;
}
...
var tc = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "image_in", "norm_rect_in", !1),
      (this.j = { detections: [] }),
      un((t = this.h = new Us()), 0, 1, (e = new Ps())),
      wn(this.h, 2, 0.5),
      wn(this.h, 3, 0.3);
  }
  get baseOptions() {
  ...
  o(t) {
    return (
      "minDetectionConfidence" in t &&
        wn(this.h, 2, t.minDetectionConfidence ?? 0.5),
      "minSuppressionThreshold" in t &&
        wn(this.h, 3, t.minSuppressionThreshold ?? 0.3),
      this.l(t)
    );
  }
  D(t, e) {
    return (this.j = { detections: [] }), qa(this, t, e), this.j;
  }
  F(t, e, n) {
    return (this.j = { detections: [] }), Ja(this, t, n, e), this.j;
  }
  m() {
    var t = new es();
    Qi(t, "image_in"), Qi(t, "norm_rect_in"), ts(t, "detections");
    const e = new Vi();
    Yn(e, Ds, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect_in"),
      Ki(n, "DETECTIONS:detections"),
      n.o(e),
      Zi(t, n),
      this.g.attachProtoVectorListener("detections", (t, e) => {
        for (const e of t) (t = ls(e)), this.j.detections.push(Ro(t));
        qo(this, e);
      }),
...
(tc.prototype.detectForVideo = tc.prototype.F),
  (tc.prototype.detect = tc.prototype.D),
  (tc.prototype.setOptions = tc.prototype.o),
  (tc.createFromModelPath = async function (t, e) {
    return Ya(tc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (tc.createFromModelBuffer = function (t, e) {
    return Ya(tc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var ec = Ha(
  ...
  ic = Ha([474, 475], [475, 476], [476, 477], [477, 474]),
  sc = Ha(
    [33, 7],
    [7, 163],
    [163, 144],
  ...
  ac = Ha([469, 470], [470, 471], [471, 472], [472, 469]),
  cc = Ha(
    [10, 338],
    [338, 297],
    [297, 332],
...
var fc = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "image_in", "norm_rect", !1),
      (this.j = {
        faceLandmarks: [],
        faceBlendshapes: [],
        facialTransformationMatrixes: [],
      ...
      (this.outputFacialTransformationMatrixes = this.outputFaceBlendshapes =
        !1),
      un((t = this.h = new js()), 0, 1, (e = new Ps())),
      (this.v = new Gs()),
      un(this.h, 0, 3, this.v),
      (this.s = new Us()),
      un(this.h, 0, 2, this.s),
      En(this.s, 4, 1),
      wn(this.s, 2, 0.5),
      wn(this.v, 2, 0.5),
      wn(this.h, 4, 0.5);
  ...
  o(t) {
    return (
      "numFaces" in t && En(this.s, 4, t.numFaces ?? 1),
      "minFaceDetectionConfidence" in t &&
        wn(this.s, 2, t.minFaceDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        wn(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minFacePresenceConfidence" in t &&
        wn(this.v, 2, t.minFacePresenceConfidence ?? 0.5),
  ...
  D(t, e) {
    return lc(this), qa(this, t, e), this.j;
  }
  F(t, e, n) {
    return lc(this), Ja(this, t, n, e), this.j;
  }
  m() {
    var t = new es();
    Qi(t, "image_in"), Qi(t, "norm_rect"), ts(t, "face_landmarks");
    const e = new Vi();
    Yn(e, Hs, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "NORM_LANDMARKS:face_landmarks"),
      n.o(e),
      Zi(t, n),
      this.g.attachProtoVectorListener("face_landmarks", (t, e) => {
        for (const e of t) (t = gs(e)), this.j.faceLandmarks.push(Fo(t));
        qo(this, e);
      }),
      ...
      this.outputFacialTransformationMatrixes &&
        (ts(t, "face_geometry"),
        Ki(n, "FACE_GEOMETRY:face_geometry"),
            ...
            for (const e of t)
              (t = an(Bs(e), ms, 2)) &&
                this.j.facialTransformationMatrixes.push({
                  rows: gn(mn(t, 1), 0) ?? 0,
                  columns: gn(mn(t, 2), 0) ?? 0,
                  data: Ke(t, 3, Wt, ze()).slice() ?? [],
                });
          qo(this, e);
        }),
...
(fc.prototype.detectForVideo = fc.prototype.F),
  ...
  (fc.createFromModelPath = function (t, e) {
    return Ya(fc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (fc.createFromModelBuffer = function (t, e) {
    return Ya(fc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
  (fc.createFromOptions = function (t, e) {
    return Ya(fc, t, e);
  }),
  (fc.FACE_LANDMARKS_LIPS = ec),
  (fc.FACE_LANDMARKS_LEFT_EYE = nc),
  (fc.FACE_LANDMARKS_LEFT_EYEBROW = rc),
  (fc.FACE_LANDMARKS_LEFT_IRIS = ic),
  (fc.FACE_LANDMARKS_RIGHT_EYE = sc),
  (fc.FACE_LANDMARKS_RIGHT_EYEBROW = oc),
  (fc.FACE_LANDMARKS_RIGHT_IRIS = ac),
  (fc.FACE_LANDMARKS_FACE_OVAL = cc),
  (fc.FACE_LANDMARKS_CONTOURS = hc),
  (fc.FACE_LANDMARKS_TESSELATION = uc);
var dc = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "image_in", "norm_rect", !0),
      un((t = this.j = new Ws()), 0, 1, (e = new Ps()));
  }
  get baseOptions() {
  ...
  Oa(t, e, n) {
    ...
    if (
      ((this.h = "function" == typeof e ? e : n), qa(this, t, r ?? {}), !this.h)
    )
      return this.s;
  }
  m() {
    var t = new es();
    Qi(t, "image_in"), Qi(t, "norm_rect"), ts(t, "stylized_image");
    const e = new Vi();
    Yn(e, zs, this.j);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "STYLIZED_IMAGE:stylized_image"),
      n.o(e),
      Zi(t, n),
      this.g.V("stylized_image", (t, e) => {
        ...
        (i = new Va([r], !1, !1, this.g.i.canvas, this.P, i, t)),
          (this.s = n = n ? i.clone() : i),
          this.h && this.h(n),
          qo(this, e);
      }),
      this.g.attachEmptyPacketListener("stylized_image", (t) => {
        (this.s = null), this.h && this.h(null), qo(this, t);
      }),
      (t = t.g()),
      this.setGraph(new Uint8Array(t), !0);
  }
};
(dc.prototype.stylize = dc.prototype.Oa),
  (dc.prototype.setOptions = dc.prototype.o),
  (dc.createFromModelPath = function (t, e) {
    return Ya(dc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (dc.createFromModelBuffer = function (t, e) {
    return Ya(dc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var _c = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "image_in", "norm_rect", !1),
      ...
      (this.worldLandmarks = []),
      (this.handedness = []),
      un((t = this.j = new Qs()), 0, 1, (e = new Ps())),
      (this.s = new Zs()),
      un(this.j, 0, 2, this.s),
      (this.C = new Js()),
      un(this.s, 0, 3, this.C),
      (this.v = new qs()),
      un(this.s, 0, 2, this.v),
      (this.h = new $s()),
      un(this.j, 0, 3, this.h),
      wn(this.v, 2, 0.5),
      wn(this.s, 4, 0.5),
      wn(this.C, 2, 0.5);
  }
  ...
  o(t) {
    if (
      (En(this.v, 3, t.numHands ?? 1),
      "minHandDetectionConfidence" in t &&
        wn(this.v, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        wn(this.s, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t &&
        wn(this.C, 2, t.minHandPresenceConfidence ?? 0.5),
      t.cannedGesturesClassifierOptions)
    ) {
      var e = new Ks(),
        n = e,
        r = xo(t.cannedGesturesClassifierOptions, an(this.h, Ks, 3)?.h());
      un(n, 0, 2, r), un(this.h, 0, 3, e);
    } else
      void 0 === t.cannedGesturesClassifierOptions && an(this.h, Ks, 3)?.g();
    return (
      t.customGesturesClassifierOptions
        ? (un(
            ...
            0,
            2,
            (r = xo(t.customGesturesClassifierOptions, an(this.h, Ks, 4)?.h()))
          ),
          un(this.h, 0, 4, e))
  ...
  Ja(t, e) {
    return gc(this), qa(this, t, e), mc(this);
  }
  Ka(t, e, n) {
    return gc(this), Ja(this, t, n, e), mc(this);
  }
  m() {
    var t = new es();
    Qi(t, "image_in"),
      ...
      ts(t, "hand_gestures"),
      ts(t, "hand_landmarks"),
      ts(t, "world_hand_landmarks"),
      ts(t, "handedness");
    const e = new Vi();
    Yn(e, io, this.j);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "HAND_GESTURES:hand_gestures"),
      Ki(n, "LANDMARKS:hand_landmarks"),
      Ki(n, "WORLD_LANDMARKS:world_hand_landmarks"),
      Ki(n, "HANDEDNESS:handedness"),
      n.o(e),
      Zi(t, n),
...
(_c.prototype.recognizeForVideo = _c.prototype.Ka),
  (_c.prototype.recognize = _c.prototype.Ja),
  (_c.prototype.setOptions = _c.prototype.o),
  (_c.createFromModelPath = function (t, e) {
    return Ya(_c, t, { baseOptions: { modelAssetPath: e } });
  }),
  (_c.createFromModelBuffer = function (t, e) {
    return Ya(_c, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Ec = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "image_in", "norm_rect", !1),
      ...
      (this.worldLandmarks = []),
      (this.handedness = []),
      un((t = this.h = new Zs()), 0, 1, (e = new Ps())),
      (this.s = new Js()),
      un(this.h, 0, 3, this.s),
      (this.j = new qs()),
      un(this.h, 0, 2, this.j),
      En(this.j, 3, 1),
      wn(this.j, 2, 0.5),
      wn(this.s, 2, 0.5),
      wn(this.h, 4, 0.5);
  ...
  o(t) {
    return (
      "numHands" in t && En(this.j, 3, t.numHands ?? 1),
      "minHandDetectionConfidence" in t &&
        wn(this.j, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        wn(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t &&
        wn(this.s, 2, t.minHandPresenceConfidence ?? 0.5),
      this.l(t)
    );
  }
  D(t, e) {
  ...
  m() {
    ...
    Yn(e, so, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "LANDMARKS:hand_landmarks"),
      Ki(n, "WORLD_LANDMARKS:world_hand_landmarks"),
      ...
      Zi(t, n),
      this.g.attachProtoVectorListener("hand_landmarks", (t, e) => {
        for (const e of t) (t = gs(e)), this.landmarks.push(Fo(t));
        qo(this, e);
      }),
      this.g.attachEmptyPacketListener("hand_landmarks", (t) => {
        qo(this, t);
      ...
      this.g.attachProtoVectorListener("world_hand_landmarks", (t, e) => {
        for (const e of t) (t = ds(e)), this.worldLandmarks.push(Io(t));
        qo(this, e);
      }),
      this.g.attachEmptyPacketListener("world_hand_landmarks", (t) => {
        qo(this, t);
...
(Ec.prototype.detectForVideo = Ec.prototype.F),
  (Ec.prototype.detect = Ec.prototype.D),
  (Ec.prototype.setOptions = Ec.prototype.o),
  (Ec.createFromModelPath = function (t, e) {
    return Ya(Ec, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Ec.createFromModelBuffer = function (t, e) {
    return Ya(Ec, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var kc = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "input_frames_image", null, !1),
      (this.h = {
        faceLandmarks: [],
        faceBlendshapes: [],
        poseLandmarks: [],
      ...
      un((t = this.j = new ho()), 0, 1, (e = new Ps())),
      (this.K = new Js()),
      un(this.j, 0, 2, this.K),
      (this.aa = new oo()),
      un(this.j, 0, 3, this.aa),
      (this.s = new Us()),
      un(this.j, 0, 4, this.s),
      (this.I = new Gs()),
      un(this.j, 0, 5, this.I),
      (this.v = new ao()),
      un(this.j, 0, 6, this.v),
      (this.L = new co()),
      un(this.j, 0, 7, this.L),
      wn(this.s, 2, 0.5),
      wn(this.s, 3, 0.3),
      wn(this.I, 2, 0.5),
      wn(this.v, 2, 0.5),
  ...
  o(t) {
    return (
      ...
      "minFaceSuppressionThreshold" in t &&
        wn(this.s, 3, t.minFaceSuppressionThreshold ?? 0.3),
      "minFacePresenceConfidence" in t &&
        wn(this.I, 2, t.minFacePresenceConfidence ?? 0.5),
      "outputFaceBlendshapes" in t &&
        (this.outputFaceBlendshapes = !!t.outputFaceBlendshapes),
      "minPoseDetectionConfidence" in t &&
        wn(this.v, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minPoseSuppressionThreshold" in t &&
        wn(this.v, 3, t.minPoseSuppressionThreshold ?? 0.3),
      "minPosePresenceConfidence" in t &&
        wn(this.L, 2, t.minPosePresenceConfidence ?? 0.5),
      ...
      "minHandLandmarksConfidence" in t &&
        wn(this.K, 2, t.minHandLandmarksConfidence ?? 0.5),
      this.l(t)
    );
  }
  D(t, e, n) {
  ...
  m() {
    var t = new es();
    Qi(t, "input_frames_image"),
      ts(t, "pose_landmarks"),
      ts(t, "pose_world_landmarks"),
      ts(t, "face_landmarks"),
      ts(t, "left_hand_landmarks"),
      ts(t, "left_hand_world_landmarks"),
      ts(t, "right_hand_landmarks"),
      ts(t, "right_hand_world_landmarks");
    const e = new Vi(),
      n = new Ri();
    Ze(
      n,
      ...
      (function (t, e) {
        if (null != e)
          if (Array.isArray(e)) Ve(t, 2, Me(e, Oe, void 0, void 0, !1));
          else {
            if (!("string" == typeof e || e instanceof B || C(e)))
              throw Error(
    ...
    const r = new Yi();
    Wi(r, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"),
      pn(r, 8, Ri, n),
      zi(r, "IMAGE:input_frames_image"),
      Ki(r, "POSE_LANDMARKS:pose_landmarks"),
      Ki(r, "POSE_WORLD_LANDMARKS:pose_world_landmarks"),
      Ki(r, "FACE_LANDMARKS:face_landmarks"),
      Ki(r, "LEFT_HAND_LANDMARKS:left_hand_landmarks"),
      Ki(r, "LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks"),
      Ki(r, "RIGHT_HAND_LANDMARKS:right_hand_landmarks"),
      Ki(r, "RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks"),
      r.o(e),
      Zi(t, r),
      Jo(this, t),
      this.g.attachProtoListener("pose_landmarks", (t, e) => {
        Ac(t, this.h.poseLandmarks), qo(this, e);
      }),
      ...
      this.g.attachProtoListener("pose_world_landmarks", (t, e) => {
        ...
        (t = ds(t)), n.push(Io(t)), qo(this, e);
      }),
      this.g.attachEmptyPacketListener("pose_world_landmarks", (t) => {
        qo(this, t);
      }),
      this.outputPoseSegmentationMasks &&
        (Ki(r, "POSE_SEGMENTATION_MASK:pose_segmentation_mask"),
        Zo(this, "pose_segmentation_mask"),
        this.g.V("pose_segmentation_mask", (t, e) => {
          (this.h.poseSegmentationMasks = [Za(this, t, !0, !this.C)]),
            qo(this, e);
        }),
        this.g.attachEmptyPacketListener("pose_segmentation_mask", (t) => {
          (this.h.poseSegmentationMasks = []), qo(this, t);
        })),
      this.g.attachProtoListener("face_landmarks", (t, e) => {
        Ac(t, this.h.faceLandmarks), qo(this, e);
      }),
      this.g.attachEmptyPacketListener("face_landmarks", (t) => {
        qo(this, t);
      }),
      this.outputFaceBlendshapes &&
        (ts(t, "extra_blendshapes"),
        Ki(r, "FACE_BLENDSHAPES:extra_blendshapes"),
        this.g.attachProtoListener("extra_blendshapes", (t, e) => {
          var n = this.h.faceBlendshapes;
          this.outputFaceBlendshapes && ((t = as(t)), n.push(Lo(t.g() ?? []))),
            qo(this, e);
        }),
      ...
      this.g.attachProtoListener("left_hand_landmarks", (t, e) => {
        Ac(t, this.h.leftHandLandmarks), qo(this, e);
      }),
      ...
      this.g.attachProtoListener("right_hand_landmarks", (t, e) => {
        Ac(t, this.h.rightHandLandmarks), qo(this, e);
      }),
...
(kc.prototype.detectForVideo = kc.prototype.F),
  ...
  (kc.createFromModelPath = function (t, e) {
    return Ya(kc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (kc.createFromModelBuffer = function (t, e) {
    return Ya(kc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
  (kc.createFromOptions = function (t, e) {
    return Ya(kc, t, e);
  }),
  (kc.HAND_CONNECTIONS = pc),
  (kc.POSE_CONNECTIONS = wc),
  (kc.FACE_LANDMARKS_LIPS = ec),
  (kc.FACE_LANDMARKS_LEFT_EYE = nc),
  (kc.FACE_LANDMARKS_LEFT_EYEBROW = rc),
  (kc.FACE_LANDMARKS_LEFT_IRIS = ic),
  (kc.FACE_LANDMARKS_RIGHT_EYE = sc),
  (kc.FACE_LANDMARKS_RIGHT_EYEBROW = oc),
  (kc.FACE_LANDMARKS_RIGHT_IRIS = ac),
  (kc.FACE_LANDMARKS_FACE_OVAL = cc),
  (kc.FACE_LANDMARKS_CONTOURS = hc),
  (kc.FACE_LANDMARKS_TESSELATION = uc);
var Sc = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "input_image", "norm_rect", !0),
      (this.j = { classifications: [] }),
      un((t = this.h = new fo()), 0, 1, (e = new Ps()));
  }
  get baseOptions() {
    return an(this.h, Ps, 1);
  }
  ...
  o(t) {
    return un(this.h, 0, 2, xo(t, an(this.h, Ss, 2))), this.l(t);
  }
  ta(t, e) {
    return (this.j = { classifications: [] }), qa(this, t, e), this.j;
  }
  ua(t, e, n) {
    return (this.j = { classifications: [] }), Ja(this, t, n, e), this.j;
  }
  m() {
    var t = new es();
    Qi(t, "input_image"), Qi(t, "norm_rect"), ts(t, "classifications");
    const e = new Vi();
    Yn(e, po, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"),
      zi(n, "IMAGE:input_image"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "CLASSIFICATIONS:classifications"),
      n.o(e),
      Zi(t, n),
      this.g.attachProtoListener("classifications", (t, e) => {
        (this.j = (function (t) {
          const e = {
            classifications: hn(t, vs, 1).map((t) =>
              Lo(an(t, ss, 4)?.g() ?? [], gn(mn(t, 2), 0), _n(t, 3))
            ),
          };
          return (
            null != te(Be(t, 2)) && (e.timestampMs = gn(te(Be(t, 2)), 0)), e
          );
        })(Es(t))),
          qo(this, e);
      }),
...
(Sc.prototype.classifyForVideo = Sc.prototype.ua),
  (Sc.prototype.classify = Sc.prototype.ta),
  (Sc.prototype.setOptions = Sc.prototype.o),
  (Sc.createFromModelPath = function (t, e) {
    return Ya(Sc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Sc.createFromModelBuffer = function (t, e) {
    return Ya(Sc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
  ...
  o(t) {
    ...
    return (
      ...
      void 0 !== t.l2Normalize
        ? vn(n, 1, t.l2Normalize)
        : "l2Normalize" in t && Ve(n, 1),
      void 0 !== t.quantize
        ? vn(n, 2, t.quantize)
        : "quantize" in t && Ve(n, 2),
      un(e, 0, 2, n),
      this.l(t)
    );
  }
  Aa(t, e) {
    return qa(this, t, e), this.embeddings;
  }
  Ba(t, e, n) {
    return Ja(this, t, n, e), this.embeddings;
  }
  m() {
    var t = new es();
    Qi(t, "image_in"), Qi(t, "norm_rect"), ts(t, "embeddings_out");
    const e = new Vi();
    Yn(e, mo, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "EMBEDDINGS:embeddings_out"),
      n.o(e),
      Zi(t, n),
      this.g.attachProtoListener("embeddings_out", (t, e) => {
        (t = ks(t)),
          (this.embeddings = (function (t) {
            return {
              embeddings: hn(t, bs, 1).map((t) => {
                const e = {
                  headIndex: gn(mn(t, 3), 0) ?? -1,
                  headName: _n(t, 4) ?? "",
                };
                if (void 0 !== on(t, ws, tn(t, 1)))
                  (t = Ke((t = an(t, ws, tn(t, 1))), 1, Wt, ze())),
                    (e.floatEmbedding = t.slice());
                else {
                  const n = new Uint8Array(0);
                  e.quantizedEmbedding = an(t, Ts, tn(t, 2))?.pa()?.h() ?? n;
                }
                return e;
              }),
              timestampMs: gn(te(Be(t, 2)), 0),
            };
          })(t)),
          qo(this, e);
      }),
...
(xc.cosineSimilarity = function (t, e) {
  if (t.floatEmbedding && e.floatEmbedding)
    t = Po(t.floatEmbedding, e.floatEmbedding);
  else {
    if (!t.quantizedEmbedding || !e.quantizedEmbedding)
      throw Error(
        "Cannot compute cosine similarity between quantized and float embeddings."
      );
    t = Po(Mo(t.quantizedEmbedding), Mo(e.quantizedEmbedding));
  }
  return t;
}),
  (xc.prototype.embedForVideo = xc.prototype.Ba),
  (xc.prototype.embed = xc.prototype.Aa),
  (xc.prototype.setOptions = xc.prototype.o),
  (xc.createFromModelPath = function (t, e) {
    return Ya(xc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (xc.createFromModelBuffer = function (t, e) {
    return Ya(xc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
function Fc(t) {
  try {
    const e = new Lc(t.confidenceMasks, t.categoryMask, t.qualityScores);
    if (!t.j) return e;
    t.j(e);
  } finally {
    Qo(t);
...
var Ic = class extends Qa {
  ...
  o(t) {
    return (
      void 0 !== t.displayNamesLocale
        ? Ve(this.h, 2, re(t.displayNamesLocale))
        : "displayNamesLocale" in t && Ve(this.h, 2),
  ...
  J() {
    !(function (t) {
      const e = hn(t.ea(), Yi, 1).filter((t) =>
        _n(t, 1).includes("mediapipe.tasks.TensorsToSegmentationCalculator")
      );
      if (((t.s = []), e.length > 1))
        throw Error(
      ...
      1 === e.length &&
        (an(e[0], Vi, 7)?.l()?.g() ?? new Map()).forEach((e, n) => {
          t.s[Number(n)] = _n(e, 1);
        });
    })(this);
  }
  ...
  m() {
    var t = new es();
    Qi(t, "image_in"), Qi(t, "norm_rect");
    const e = new Vi();
    Yn(e, To, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      n.o(e),
      Zi(t, n),
      ...
      this.outputConfidenceMasks &&
        (ts(t, "confidence_masks"),
        Ki(n, "CONFIDENCE_MASKS:confidence_masks"),
        Zo(this, "confidence_masks"),
        this.g.da("confidence_masks", (t, e) => {
          (this.confidenceMasks = t.map((t) => Za(this, t, !0, !this.j))),
            qo(this, e);
        }),
        this.g.attachEmptyPacketListener("confidence_masks", (t) => {
          (this.confidenceMasks = []), qo(this, t);
        })),
      this.outputCategoryMask &&
        (ts(t, "category_mask"),
        Ki(n, "CATEGORY_MASK:category_mask"),
        Zo(this, "category_mask"),
        this.g.V("category_mask", (t, e) => {
          (this.categoryMask = Za(this, t, !1, !this.j)), qo(this, e);
        }),
        this.g.attachEmptyPacketListener("category_mask", (t) => {
          (this.categoryMask = void 0), qo(this, t);
        })),
      ts(t, "quality_scores"),
      Ki(n, "QUALITY_SCORES:quality_scores"),
      this.g.attachFloatVectorListener("quality_scores", (t, e) => {
        (this.qualityScores = t), qo(this, e);
      }),
...
(Ic.prototype.getLabels = Ic.prototype.Ea),
  (Ic.prototype.segmentForVideo = Ic.prototype.Ma),
  (Ic.prototype.segment = Ic.prototype.segment),
  (Ic.prototype.setOptions = Ic.prototype.o),
  (Ic.createFromModelPath = function (t, e) {
    return Ya(Ic, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Ic.createFromModelBuffer = function (t, e) {
    return Ya(Ic, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Hc = class extends Qa {
  ...
  segment(t, e, n, r) {
    ...
    const s = new jc();
    var o = new Pc();
    if ((En(o, 1, 255), un(s, 0, 12, o), e.keypoint && e.scribble))
  ...
  m() {
    var t = new es();
    Qi(t, "image_in"), Qi(t, "roi_in"), Qi(t, "norm_rect_in");
    const e = new Vi();
    Yn(e, To, this.h);
    const n = new Yi();
    Wi(
...
(Hc.prototype.segment = Hc.prototype.segment),
  (Hc.prototype.setOptions = Hc.prototype.o),
  (Hc.createFromModelPath = function (t, e) {
    return Ya(Hc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Hc.createFromModelBuffer = function (t, e) {
    return Ya(Hc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Wc = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "input_frame_gpu", "norm_rect", !1),
      (this.j = { detections: [] }),
      un((t = this.h = new bo()), 0, 1, (e = new Ps()));
  }
  get baseOptions() {
    return an(this.h, Ps, 1);
  }
  ...
  o(t) {
    return (
      void 0 !== t.displayNamesLocale
        ...
        : "displayNamesLocale" in t && Ve(this.h, 2),
      void 0 !== t.maxResults
        ? En(this.h, 3, t.maxResults)
        : "maxResults" in t && Ve(this.h, 3),
      void 0 !== t.scoreThreshold
        ? wn(this.h, 4, t.scoreThreshold)
        : "scoreThreshold" in t && Ve(this.h, 4),
      void 0 !== t.categoryAllowlist
        ? Tn(this.h, 5, t.categoryAllowlist)
        : "categoryAllowlist" in t && Ve(this.h, 5),
      void 0 !== t.categoryDenylist
        ? Tn(this.h, 6, t.categoryDenylist)
        : "categoryDenylist" in t && Ve(this.h, 6),
      this.l(t)
    );
  }
  D(t, e) {
  ...
  m() {
    var t = new es();
    Qi(t, "input_frame_gpu"), Qi(t, "norm_rect"), ts(t, "detections");
    const e = new Vi();
    Yn(e, Ao, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.ObjectDetectorGraph"),
      zi(n, "IMAGE:input_frame_gpu"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "DETECTIONS:detections"),
      n.o(e),
      Zi(t, n),
...
(Wc.prototype.detectForVideo = Wc.prototype.F),
  (Wc.prototype.detect = Wc.prototype.D),
  (Wc.prototype.setOptions = Wc.prototype.o),
  (Wc.createFromModelPath = async function (t, e) {
    return Ya(Wc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Wc.createFromModelBuffer = function (t, e) {
    return Ya(Wc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
function Yc(t) {
  try {
    const e = new zc(t.landmarks, t.worldLandmarks, t.segmentationMasks);
    if (!t.s) return e;
    t.s(e);
  } finally {
    Qo(t);
...
var $c = class extends Qa {
  constructor(t, e) {
    super(new Ka(t, e), "image_in", "norm_rect", !1),
      ...
      un((t = this.h = new ko()), 0, 1, (e = new Ps())),
      (this.v = new co()),
      un(this.h, 0, 3, this.v),
      (this.j = new ao()),
      un(this.h, 0, 2, this.j),
  ...
  o(t) {
    return (
      "numPoses" in t && En(this.j, 4, t.numPoses ?? 1),
      "minPoseDetectionConfidence" in t &&
        wn(this.j, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        wn(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minPosePresenceConfidence" in t &&
        wn(this.v, 2, t.minPosePresenceConfidence ?? 0.5),
  ...
  m() {
    ...
    Qi(t, "image_in"),
      Qi(t, "norm_rect"),
      ts(t, "normalized_landmarks"),
      ts(t, "world_landmarks"),
      ts(t, "segmentation_masks");
    const e = new Vi();
    Yn(e, So, this.h);
    const n = new Yi();
    Wi(n, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
      zi(n, "IMAGE:image_in"),
      zi(n, "NORM_RECT:norm_rect"),
      Ki(n, "NORM_LANDMARKS:normalized_landmarks"),
      Ki(n, "WORLD_LANDMARKS:world_landmarks"),
      n.o(e),
      Zi(t, n),
      Jo(this, t),
      ...
      this.g.attachEmptyPacketListener("world_landmarks", (t) => {
        (this.worldLandmarks = []), qo(this, t);
      }),
      this.outputSegmentationMasks &&
        (Ki(n, "SEGMENTATION_MASK:segmentation_masks"),
        Zo(this, "segmentation_masks"),
        this.g.da("segmentation_masks", (t, e) => {
          (this.segmentationMasks = t.map((t) => Za(this, t, !0, !this.s))),
            qo(this, e);
        }),
        this.g.attachEmptyPacketListener("segmentation_masks", (t) => {
          (this.segmentationMasks = []), qo(this, t);
        })),
      (t = t.g()),
      this.setGraph(new Uint8Array(t), !0);
  }
};
($c.prototype.detectForVideo = $c.prototype.F),
  ($c.prototype.detect = $c.prototype.D),
  ($c.prototype.setOptions = $c.prototype.o),
  ($c.createFromModelPath = function (t, e) {
    return Ya($c, t, { baseOptions: { modelAssetPath: e } });
  }),
  ($c.createFromModelBuffer = function (t, e) {
    return Ya($c, t, { baseOptions: { modelAssetBuffer: e } });
  }),
  ($c.createFromOptions = function (t, e) {
    return Ya($c, t, e);
  }),
  ($c.POSE_CONNECTIONS = wc);
export {
  tc as FaceDetector,
  fc as FaceLandmarker,
  dc as FaceStylizer,
  Do as FilesetResolver,
  _c as GestureRecognizer,
  Ec as HandLandmarker,
  kc as HolisticLandmarker,
  Sc as ImageClassifier,
  xc as ImageEmbedder,
  Ic as ImageSegmenter,
  Lc as ImageSegmenterResult,
  Hc as InteractiveSegmenter,
  Mc as InteractiveSegmenterResult,
  Va as MPImage,
  Ta as MPMask,
  Wc as ObjectDetector,
  $c as PoseLandmarker,
  Qa as VisionTaskRunner,
};
