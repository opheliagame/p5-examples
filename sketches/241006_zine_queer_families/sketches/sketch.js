...
function setup() {
  // 4.25 x 5.5 inches 107.95 x 139.7 mm with 300 DPI => 1275 x 1650
  // 148 x 210 mm with 300 DPI => 1748 x 2480

  createCanvas(1748, 2480, WEBGL); // Set up WebGL context
  ...
  // image(bgTex, 0, 0)
  wrapTexture(bgTex, dvert2, subdivisionRows, subdivisionCols, this);
  pop();
  ...
  let minTextSize = map(text1.length, mintextlength, maxtextlength, 48, 22);
  spaceOut(text1, textCanvas, true, minTextSize, minTextSize * 2);
  ...
  wrapTexture(textCanvas, dverts1, subdivisionRows, subdivisionCols, this);
}
